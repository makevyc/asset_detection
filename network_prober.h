...
public:
    ...
    bool pingHost(const std::string& host, int& avg_delay, int& loss, const __suseconds_t timeout, const int count); //ping检测
    bool probePort(const std::string& host, int port, int timeout);//TCP端口检测
