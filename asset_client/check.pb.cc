...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_check_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_check_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_check_2eproto = nullptr;

const uint32_t TableStruct_check_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_check_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013check.proto\022\017AssetInspection\"\027\n\005Check\022"
  "\016\n\006target\030\001 \001(\t\")\n\nIPResponse\022\r\n\005delay\030\001"
  " \001(\005\022\014\n\004loss\030\002 \001(\005\"\033\n\013TCPResponse\022\014\n\004fla"
  "g\030\001 \001(\0102\237\001\n\026AssetInspectionService\022@\n\007Ch"
  "eckIP\022\026.AssetInspection.Check\032\033.AssetIns"
  "pection.IPResponse\"\000\022C\n\tCheckPort\022\026.Asse"
  "tInspection.Check\032\034.AssetInspection.TCPR"
  "esponse\"\000b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_check_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_check_2eproto = {
  false, false, 297, descriptor_table_protodef_check_2eproto, "check.proto", 
  &descriptor_table_check_2eproto_once, nullptr, 0, 3,
  schemas, file_default_instances, TableStruct_check_2eproto::offsets,
  file_level_metadata_check_2eproto, file_level_enum_descriptors_check_2eproto, file_level_service_descriptors_check_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_check_2eproto_getter() {
  return &descriptor_table_check_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_check_2eproto(&descriptor_table_check_2eproto);
namespace AssetInspection {
...
::PROTOBUF_NAMESPACE_ID::Metadata Check::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_check_2eproto_getter, &descriptor_table_check_2eproto_once,
      file_level_metadata_check_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata IPResponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_check_2eproto_getter, &descriptor_table_check_2eproto_once,
      file_level_metadata_check_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata TCPResponse::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_check_2eproto_getter, &descriptor_table_check_2eproto_once,
      file_level_metadata_check_2eproto[2]);
}
